...
- تاريخ التوليد: 2026-08-16T14:37:15.068Z
- الدورات: 20/20
...
| 5 | CRITICAL | حد RSI الأعلى مطبق على كل توصية | COPR:67.9, ETEL:66, ZEOT:72.9, AALR:67.3, CANA:80.6 | نقل السهم إلى المراقبة. |
| 5 | HIGH | بوابة الامتداد القصير تمنع المطاردة | COPR:ret5=7.5, ETEL:ret5=3.68, ZEOT:ret5=8.79, AALR:ret5=2.42, CANA:ret5=10.26 | خفض الترتيب أو إلغاء الدخول. |
| 6 | HIGH | اتساع الأسعار يكفي للتنفيذ المتقاطع | acceptedRows=0 | حجب المسح عند ضعف التغطية. |
| 8 | HIGH | احتمال الهدف أعلى من احتمال الوقف | COPR:10.095>17.486, ETEL:9.674>16.673, ZEOT:9.812>16.443, AALR:9.277>15.515, CANA:10.167>16.07 | إعادة المعايرة أو الرفض. |
| 15 | HIGH | عدم الاستقرار موثق ولا يُخفى | COPR:Pilot محسّن — يحتاج سجلًا حيًا أطول/REDUCED_RISK_TWO_POSITIONS_MAX, ETEL:Pilot محسّن — يحتاج سجلًا حيًا أطول/REDUCED_RISK_TWO_POSITIONS_MAX, ZEOT:Pilot محسّن — يحتاج سجلًا حيًا أطول/REDUCED_RISK_TWO_POSITIONS_MAX, AALR:Pilot محسّن — يحتاج سجلًا حيًا أطول/REDUCED_RISK_TWO_POSITIONS_MAX, CANA:Pilot محسّن — يحتاج سجلًا حيًا أطول/REDUCED_RISK_TWO_POSITIONS_MAX | إظهار عدم الاستقرار وخفض المخاطرة. |
