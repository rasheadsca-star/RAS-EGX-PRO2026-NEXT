...
test('date-aligned outcome comparison awards exactly one independent point',()=>{
  const sim={
    ...
    records:[
      {signalSession:'2026-08-04',outcome:'TARGET1',netReturnPct:3},
      {signalSession:'2026-08-04',outcome:'TARGET2',netReturnPct:5},
      {signalSession:'2026-08-05',outcome:'STOP',netReturnPct:-2},
      {signalSession:'2026-08-05',outcome:'TIMEOUT',netReturnPct:-0.1},
      {signalSession:'2026-08-06',outcome:'STOP',netReturnPct:-3}
    ]
  };
...
test('missing exact/date-aligned evidence produces N/A leader and no fabricated point',()=>{
  const sim={legacyComparison:{comparisonRules:{v16Comparison:'DATE_ALIGNED_POLICY_COMPARISON'},commonDates:['2026-08-04'],newTechnique:{evidenceGrade:'POINT_IN_TIME_HISTORICAL_REPLAY'},v16_9:{evidenceGrade:'RECONSTRUCTED',commonSignalDates:1,targetHitRatePct:40}},records:[{signalSession:'2026-08-04',outcome:'TARGET1'}]};
