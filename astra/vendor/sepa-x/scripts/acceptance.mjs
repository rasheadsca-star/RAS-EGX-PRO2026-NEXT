...
const checks={
  ...
  deterministicSchema:s.schemaVersion===DEFAULT_CONFIG.schemaVersion,
...
console.log(JSON.stringify({expectedSchemaVersion:DEFAULT_CONFIG.schemaVersion,actualSchemaVersion:s.schemaVersion,checks},null,2));if(Object.values(checks).some(x=>!x))process.exit(1);
