...
const SOURCE_PATHS=Object.freeze({
  ...
  MOMENTUM:Object.freeze(['scripts/stable/v15-practical-market-scanner.cjs']),
  REVERSAL:Object.freeze(['scripts/stable/v15-practical-market-scanner.cjs']),
  ...
  V16_TWO_STAGE_TOP_GAINER:Object.freeze(['scripts/research/v16-probabilistic-model-impact.py','scripts/research/v16-two-stage-predictor.py']),
  V16_TRIPLE_BARRIER_GATE:Object.freeze(['scripts/research/v16-v167-blocked-run.py']),
  V19_TOP10_PROBABILITY_INV_VOL_3:Object.freeze(['scripts/v19/native-challenger-v2.py','scripts/v19/native-challenger-v4.py','scripts/v19/native-challenger-v6.py']),
  ...
  SEPA_QVUA_NEAR_FIRST_THEN_FORMING:Object.freeze(['sepa-x/src/engine.js','sepa-x/src/config.js','gann-fusion-x/engine/sepa-adapter.js','gann-fusion-x/data/sepa-x-snapshot.json']),
