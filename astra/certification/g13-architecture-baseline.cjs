...
const ZONES=[
  ...
  {id:'corporate-actions',exact:'astra/core/corporate-actions.cjs',modules:['corporate-actions'],kind:'target-module'},
  ...
  {id:'portfolio',exact:'astra/portfolio/portfolio.cjs',modules:['portfolio'],kind:'target-module'},
  {id:'portfolio-unmapped',prefix:'astra/portfolio/',modules:[],kind:'active-unregistered-layer'},
  {id:'backtest',exact:'astra/evaluation/backtest.cjs',modules:['backtest'],kind:'target-module'},
  {id:'walk-forward',exact:'astra/evaluation/walk-forward.cjs',modules:['walk-forward'],kind:'target-module'},
  {id:'evaluation-unmapped',prefix:'astra/evaluation/',modules:[],kind:'active-unregistered-layer'},
