...
test('large source conflict cannot be eligible',()=>{const a=analyzeTicker({ticker:'X',rows:gen(100),historyMeta:{warnings:['latest_close_conflict:25%']}});assert.equal(a.eligible,false)});
