...
function fail(message) {
  console.error(`V13.15.2 EVIDENCE ACCEPTANCE FAILURE: ${message}`);
  process.exit(1);
}
...
if (center.patchVersion !== '13.15.2') fail(`unexpected center patch ${center.patchVersion}`);
...
console.log(`V13.15.2 evidence acceptance passed: signals=${ids.length}, strategies=${health.strategies.length}.`);
