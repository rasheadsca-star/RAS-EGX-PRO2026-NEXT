...
function fail(message) {
  console.error(`V13.16 EVIDENCE ACCEPTANCE FAILURE: ${message}`);
  process.exit(1);
}
...
console.log(`V13.16 evidence acceptance passed: signals=${ids.length}, strategies=${health.strategies.length}.`);
