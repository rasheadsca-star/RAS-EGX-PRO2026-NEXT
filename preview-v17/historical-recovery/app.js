...
(() => {
  ...
  function renderAcquisitionCoverage() {
    ...
    const labels = { companyIdentity: 'مراجعة هوية الشركة', financialDocument: 'مراجعة مستند مالي', publicationTiming: 'مراجعة توقيت النشر', currencyUnit: 'مراجعة العملة/الوحدة', sourceConflict: 'مراجعة اختلاف المصادر', corporateAction: 'مراجعة إجراء رأسمالي', disclosure: 'مراجعة الإفصاح', newsClassification: 'مراجعة تصنيف الخبر' };
