...
const registry = {
  ok: true,
  engine: 'v11_3_historical_source_registry',
  generatedAt,
  ...
  note: 'V11.3 accelerates readiness by automated public/optional licensed backfill only. Manual CSV and broker-screen data are intentionally excluded.'
};
