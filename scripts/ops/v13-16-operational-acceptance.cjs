...
function fail(message) {
  console.error(`V13.17.1 OPERATIONAL ACCEPTANCE FAILURE: ${message}`);
  process.exit(1);
}
...
console.log(`V13.17.1 operational acceptance passed: state=${ops.state}, scheduledLegacy=${workflowAudit.counts?.scheduledLegacy || 0}, report=${report.sessionDate}.`);
