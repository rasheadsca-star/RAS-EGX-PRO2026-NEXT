...
const truthSession=validDate(sessionTruth.selectedSessionDate)?sessionTruth.selectedSessionDate:null;
const historySession=validDate(history.sessionDate)?history.sessionDate:null;
const referenceSessionDate=sessionTruth.executionSafe===true&&truthSession?truthSession:historySession;
