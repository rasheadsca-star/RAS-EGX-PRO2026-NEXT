...
const liquidityResearchAligned = liquidity.referenceSessionDate === current.sessionDate && liquidity.referenceSessionDate === internal.referenceSessionDate;
test('liquidity:session-aligned', executionGrade ? (liquidity.sessionAligned === true && liquidityResearchAligned) : (liquidity.sessionAligned === false && liquidityResearchAligned && liquidity.gatePassed === false), `executionGrade=${executionGrade}; sessionAligned=${liquidity.sessionAligned}; liquidity=${liquidity.referenceSessionDate}; current=${current.sessionDate}`);
