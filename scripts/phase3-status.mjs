...
const report={
  schemaVersion:'egx-one-phase3-status-3',
  generatedFrom:'reproducible_checked_in_official_identity_sample',
  asOfDate:fixture.asOfDate,
  policy:{sourceReceiptsRequired:true,independentProviderCrossCheckRequired:true,searchSnippetsMayBeAuthoritativeRawEvidence:false,unverifiedBulletinContentMayAuthorizeBaseline:false,officialInclusionEvidenceRequiresReceiptAndScopeProof:true},
  ...
  sourceProvenance:{state:'NOT_EVALUATED_UNTIL_EXHAUSTIVE_UNIVERSE_AND_CURRENT_SESSION',requiredRuntimeReceipts:['PRIMARY_AUTHORITATIVE_RECEIPT','INDEPENDENT_CROSSCHECK_RECEIPT'],requiredUniverseProofs:['OFFICIAL_SOURCE_RECEIPT_HASH','OFFICIAL_DOCUMENT_SCOPE_PROOF_HASH']},
