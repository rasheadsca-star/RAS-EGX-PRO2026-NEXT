...
if(!data.leadershipSummary||!data.forwardLedgerSummary||!data.dataHealth||!data.enginePerformanceLeague||!data.recommendationPositionPerformance||!data.externalEngineRegistry)throw new Error('V18 required summaries/performance modules missing');
