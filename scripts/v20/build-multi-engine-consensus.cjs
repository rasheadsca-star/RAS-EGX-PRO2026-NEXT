...
const monitoredNonVotes=[
 {id:'V13_HISTORICAL_LINEAGE',label:'V13 historical family',role:'LEGACY_HISTORICAL_ENGINE',voteEligible:false,status:'ARCHIVED_HISTORICAL',artifact:'data/research/v13-20-multi-session-results.json',reason:'Historical multi-session lineage. Retrospective evidence only; no live same-session canonical vote.'},
 {id:'V14_HISTORICAL_LINEAGE',label:'V14 historical family',role:'LEGACY_HISTORICAL_ENGINE',voteEligible:false,status:'ARCHIVED_HISTORICAL',artifact:'data/research/v13-20-multi-session-results.json',reason:'Historical multi-session lineage. Retrospective evidence only; no live same-session canonical vote.'},
 {id:'V15_PRACTICAL_DECISION',label:'V15 Practical Decision',role:'LEGACY_HISTORICAL_ENGINE',voteEligible:false,status:'ARCHIVED_HISTORICAL',artifact:'data/research/v15-practical-validation.json',reason:'Historical lineage; monitored for retrospective overlap only.'},
 ...
 {id:'V16_6_TRIPLE_BARRIER',label:'V16.6 Triple Barrier / Gate',role:'LEGACY_RESEARCH_ENGINE',voteEligible:false,status:'ARCHIVED_HISTORICAL',artifact:'data/research/v16-v166-triple-barrier.json',reason:'Historical V16 research lineage; tracked but not double-counted against the V16.9 production descendant.'},
 {id:'V16_7_COHERENT_ENGINE',label:'V16.7 Coherent Engine',role:'LEGACY_RESEARCH_ENGINE',voteEligible:false,status:'ARCHIVED_HISTORICAL',artifact:'data/research/v16-v167-coherent-engine.json',reason:'Historical V16 research lineage; tracked but not double-counted against the V16.9 production descendant.'},
 {id:'V16_8_PRACTICAL_SELECTOR',label:'V16.8 Practical Selector',role:'LEGACY_RESEARCH_ENGINE',voteEligible:false,status:'ARCHIVED_HISTORICAL',artifact:'data/research/v16-v168-practical-selector.json',reason:'Historical V16 research lineage; tracked but not double-counted against the V16.9 production descendant.'},
...
const annotations=rows.filter(r=>r.mainAppSelected).map(r=>{
 ...
 return {ticker:r.ticker,independentVotes:r.independentVotes,independentEngineCount:3,confirmationScore:r.confirmationScore,confirmationLevel:r.confirmationLevel,confirmationLabelAr:label,confirmingEngines:confirmations,noteAr:msg,v17Validation:r.v17Validation};
});
const report={schemaVersion:'20.0.0-multi-engine-consensus-1',generatedAt:new Date().toISOString(),sessionDate:aligned?session:null,status:aligned?'CURRENT_SESSION_ALIGNED':'SESSION_MISMATCH_FAIL_CLOSED',
 ...
 engineRegistry:{activeIndependent,monitoredNonVotes,monitoredEngineCount:activeIndependent.length+monitoredNonVotes.length,rule:'Only canonical, current-session, genuinely independent recommendation/discovery engines may add a confirmation vote. Validators, same-lineage versions, archived engines, experiments without canonical output, and nonexistent versions never add votes.'},
 ...
 historicalEvidence:{pairEvidenceSource:'data/v20/cross-version-consensus.json',multiSessionArchiveSource:'data/research/v13-20-multi-session-results.json',v16V19Consensus:cross.historicalEvidence?.v16V19Consensus||null,v16OnlyNonConsensus:cross.historicalEvidence?.v16OnlyNonConsensus||null,recurringConsensusTickers:cross.historicalEvidence?.recurringConsensusTickers||[],note:'Historical engine lineages are monitored as retrospective evidence. They do not become current votes unless a same-session canonical artifact exists and independence is proven.'},
