...
check(registry.policy?.v18PerformanceAccepted === false, 'V18_PERFORMANCE_FALSELY_ACCEPTED');
...
check(registry.externalReferences?.v18?.acceptedForPerformanceClaims === false, 'V18_EXTERNAL_PERFORMANCE_ACCEPTED');
...
const report = {
  ...
  checks: {
    ...
    v18PerformanceNotAcceptedWithoutAudit: true,
